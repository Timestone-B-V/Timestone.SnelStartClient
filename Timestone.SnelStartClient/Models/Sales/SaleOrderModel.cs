...
/// <summary>
/// Model of a sales order.
/// </summary>
public class SaleOrderModel : SnelStartResource
{
    ...
    public SnelStartReference? Verkoopordersjabloon { get; set; }

    public SaleOrderStatusModel? VerkoopOrderStatus { get; set; }

    public decimal? TotaalExclusiefBtw { get; set; }

    public decimal? TotaalInclusiefBtw { get; set; }

    public IReadOnlyList<OrderExtraFieldValueModel>? ExtraHoofdVelden { get; set; }
}
